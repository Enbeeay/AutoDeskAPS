...
.EXAMPLE
Remove-APSCostContract -ProjectID $ProjectID -contractId $contract

Deletes the specified Contract object in the project.

.NOTES
Autodesk API Documentation - https://aps.autodesk.com/en/docs/acc/v1/reference/http/cost-contracts-contractId-DELETE/
#>
function Remove-APSCostContract {
    Param(
        [Alias("containerId")]
    ...
    $DELETEUrl = "https://developer.api.autodesk.com/cost/v1/containers/$($ProjectID)/contracts/$($contractId)"
